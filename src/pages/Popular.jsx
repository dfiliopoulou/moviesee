  ...
  useEffect(() => {
    ...
    const getPopular = async () => {
      const api = await fetch(
        `${process.env.REACT_APP_BASE_URL}/popular?api_key=${process.env.REACT_APP_API_KEY}&page=${page}`
      );
  ...
  return (
    <>
      ...
      <div className="global-container">
        <h1 className="main__header">Most Popular Movies</h1>
        <div className="default__container popular">
          {popular.map((movie) => {
